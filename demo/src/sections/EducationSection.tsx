  ...
  return (
    <section className="section-panel">
      ...
      <header className="section-header">
        <div>
          <p className="eyebrow">Section 4 of 4</p>
          <h2>Education</h2>
          <p>Qualifications used to assess this application.</p>
        </div>
      ...
      <form onSubmit={(event) => event.preventDefault()}>
        <fieldset className="form-block">
          ...
          <div className="form-grid">
            ...
            <label className="choice choice--standalone">
              <input type="checkbox" {...form.register("currentlyStudying")} />{" "}
        ...
        <fieldset className="form-block">
          <div className="legend-row">
            ...
            >
              <span aria-hidden="true">+</span> Add qualification
            </button>
          </div>
          <div className="array-list">
            {entries.fields.map((entry, index) => (
              <div className="array-row" key={entry.fieldId}>
                <div className="array-row__header">
                ...
                <input
                  type="hidden"
                  {...form.register(`entries.${index}.id`)}
                />
                <div className="form-grid">
                  <label>
                    Institution
                    <input {...form.register(`entries.${index}.institution`)} />
                  </label>
                  <label>
                    Qualification
                    <input
                      {...form.register(`entries.${index}.qualification`)}
                    />
                  </label>
                  <label>
                    Field of study
                    <input
                      {...form.register(`entries.${index}.fieldOfStudy`)}
                    />
                  </label>
                  <label>
                    Graduation year
                    <input
                      ...
                      min="1950"
                      max="2100"
                      {...form.register(`entries.${index}.graduationYear`, {
                        valueAsNumber: true,
                      })}
                    />
                  </label>
