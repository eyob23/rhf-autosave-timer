...
function EmploymentFormSection({ applicationId }: { applicationId: string }) {
  ...
  if (loadError)
    return <p role="alert">Could not load employment information.</p>;
  ...
  return (
    <section className="section-panel">
      ...
      <header className="section-header">
        <div>
          <p className="eyebrow">Section 2 of 4</p>
          <h2>Employment and income</h2>
          <p>Current work arrangement and annual income details.</p>
        </div>
        ...
        <fieldset className="form-block">
          ...
          <div className="form-grid">
            ...
            <label className="choice choice--standalone">
              <input type="checkbox" {...form.register("remote")} /> I primarily
              work remotely
            </label>
            <label className="full">
              Primary responsibilities
              <textarea rows={5} {...form.register("responsibilities")} />
            </label>
          </div>
        </fieldset>
      </form>
