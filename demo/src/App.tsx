      ...
      <div className="shell">
        <aside>
          ...
          <div className="record-picker">
            ...
            <select
              ...
              onChange={(event) =>
                navigate(
                  `/applications/${event.target.value}/${currentSection}`,
                )
              }
            >
          ...
          <nav aria-label="Application sections">
            <NavLink to="personal">
              <span>1</span>
              <div>
                Personal<small>Identity and contact</small>
              </div>
            </NavLink>
            <NavLink to="employment">
              <span>2</span>
              <div>
                Employment<small>Work and income</small>
              </div>
            </NavLink>
            <NavLink to="household">
              <span>3</span>
              <div>
                Household<small>Members and housing</small>
              </div>
            </NavLink>
            <NavLink to="education">
              <span>4</span>
              <div>
                Education<small>Qualifications</small>
              </div>
            </NavLink>
          </nav>
        ...
        <div className="workspace">
          <header className="topbar">
            <div>
              <p>Applications / {summary?.reference ?? "Loading"}</p>
              <h1>{summary?.applicantName ?? "Application"}</h1>
            </div>
